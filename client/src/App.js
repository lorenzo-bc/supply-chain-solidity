...
class App extends Component {
  ...
  handleSubmit = async () => {
    ...
    console.log(result);
    alert("Send "+cost+" Wei to "+result.events.SupplyChainStep.returnValues._itemAddress + " item with index "+result.events.SupplyChainStep.returnValues._itemIndex + " got created");
  };
